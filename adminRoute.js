...
router.get('/get-all-doctors', authMiddleware, async (req, res) => {
    try {
        ...
        res.status(200).send({ message: "Error applying the doctor account", success: true, data: doctors, });
...
router.get('/get-all-users', authMiddleware, async (req, res) => {
    try {
        ...
        res.status(200).send({ message: "Error applying the doctor account", success: true, data: users, });
